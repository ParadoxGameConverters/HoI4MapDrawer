#ifndef SRC_COUNTRY_COLORS_COUNTRY_TAG_FILE_READER_H
#define SRC_COUNTRY_COLORS_COUNTRY_TAG_FILE_READER_H
...
#endif  // SRC_COUNTRY_COLORS_COUNTRY_TAG_FILE_READER_H