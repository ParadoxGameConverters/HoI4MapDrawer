...
{
   const auto configuration = hoi4_map_drawer::ImportConfiguration("./test_data/configuration/empty_config.txt");
...
{
   const auto configuration = hoi4_map_drawer::ImportConfiguration("./test_data/configuration/test_config.txt");
